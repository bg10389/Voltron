...
def capture_live_data(sensor_ip: str, lidar_port: int = 7502, imu_port: int = 7503):
    try:
...
if __name__ == "__main__":
    sensor_ip = "192.168.1.1"  # Replace with your sensor's IP address
    capture_live_data(sensor_ip)